...
SEARCH_URL = "https://www.uml.edu/search/?type=media-news"


class NewsSearchResultItem(TypedDict):
    title: str
    detail: str
    url: str


async def query_news(query: str, top_k: int):
    """
    Query UMass Lowell News
    """
